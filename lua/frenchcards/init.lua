...
local function check_answer()
    ...
    if M.is_correct(user_answer, current_card.a) then
...
function M.open_flashcard()
    ...
    vim.api.nvim_buf_set_lines(buf, 0, -1, false, M.card_lines(current_card))
...
vim.api.nvim_create_user_command("French", M.open_flashcard, {})
